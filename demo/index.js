...
async function main() {
    try {
        const options = {
            header: '<p style="text-align: center; font-size: 12px; color: #666;">Company Header - Confidential Document</p>',
            footer: '<p style="text-align: center; font-size: 10px; color: #666;">Page 1 | Generated by html-to-docx | © 2025</p>'
        };
